...
public partial class DbventaContext : DbContext
{
    ...
    //        => optionsBuilder.UseSqlServer("Server=(local); DataBase=DBVENTA;Integrated Security=true;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240C34FECC90");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843FE0A2F687");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48376A73387");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E1077AD653EA");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EC30DACB0");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A1322383132B");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F768FE430D1");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D81A965ADF");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEDC6D4FF5");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A65F72F142");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614B1726D01");
